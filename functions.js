...
async function intelligentSOS(_guild, client, eventType) {
    if(_guild.protection.intelligentSOS.cooldown == false) {
        ...
        if(!invite == undefined) {
            client.channels.cache.get('833036300457082940').send('@everyone SOS de `' + eventType + '`:\nhttps://discord.gg/' + invite);
            client.channels.cache.get('833035796297547796').send('@everyone SOS de `' + eventType + '`:\nhttps://discord.gg/' + invite);
        }
